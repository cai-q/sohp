...
<head>
    <meta charset="utf-8">
    <title><?=$startday?>-<?=$endday?>|每日更新量报表</title>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php foreach ($web_list as $k => $v): ?>
                            <li><a href="/sohp/index.php?c=period&m=between&site=<?=$k ?>&start=<?=$startday ?>&end=<?=$endday ?>"><?=$v['name'] ?></a></li>
                        <?php endforeach?>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="/sohp/index.php?c=period&m=overview&site=<?=$site ?>">基于时间段</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div class="page-header">
    <h1 class="col-md-offset-2">
        <small>
            <span style="color: gray;"><?=$startday_string?></span>-
            <span style="color: gray;"><?=$endday_string?></span>
            <button class="btn btn-primary btn-xs" data-toggle="collapse" data-target="#collapse">
                <span class="glyphicon glyphicon-calendar"></span>
            </button>总更新量 ：
        </small>
        <span id="total_sum">没有数据<span>
    </h1>
</div>
...
<div class="collapse" id="collapse">
    <div class="col-md-10 col-md-offset-1 alert alert-info">
        ...
        <button id="period_confirm" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-arrow-right"></span></button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#period_confirm").click(function () {
        ...
        if(typeof startday == "undefined" || typeof endday=="undefined"){
            ...
            window.location.href = "/sohp/index.php?c=period&m=between&site=<?=$site ?>&start=" + startday + "&end=" + endday;
        }
    })
</script>
<script>
